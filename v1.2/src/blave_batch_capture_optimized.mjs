...
async function main() {
  ...
  const batchOutDir = path.join(outRoot, `batch_optimized_${stamp}`);
  await ensureDir(batchOutDir);
  await ensureDir(profileDir);

  console.log("========================================");
  console.log("Blave Batch Capture System (Optimized)");
  console.log("========================================");
  console.log(`Total tasks: ${tasks.length} (only verified working APIs)`);

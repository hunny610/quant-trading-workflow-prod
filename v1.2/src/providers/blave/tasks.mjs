export const TASKS = {
  "blave:economic_calendar": {
    name: "經濟行事曆",
    url: "https://blave.org/studio/zh/charts/economic_calendar",
    apiUrl: null,
  ...
  "blave:tokenized_stock": {
    name: "美股代幣",
    url: "https://blave.org/studio/zh/charts/tokenized_stock",
    apiUrl: null,
  ...
  "blave:crypto_card": {
    name: "加密支付卡",
    url: "https://blave.org/studio/zh/charts/crypto_card",
    apiUrl: null,
  ...
  "blave:x:trending": {
    name: "X趨勢",
    url: "https://blave.org/studio/zh/charts/x/trending",
    apiUrl: null,
  ...
  "blave:toptrader:position": {
    ...
    apiUrl: "https://api.blave.org/studio/charts/blave_top_trader/position",
...
export function listTasks() {
  return Object.entries(TASKS).map(([key, task]) => ({ key, ...task }));
}
